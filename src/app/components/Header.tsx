        ...
        <nav
            ...
            <div className="max-w-7xl mx-auto px-10 flex justify-between items-center">
                ...
                <div className="hidden md:flex space-x-12">
                    <Link href="/public" className="text-lg font-semibold hover:text-gray-200 transition duration-300">
                        Home
                    </Link>
                    ...
                    <Link href="/src/app/components/Contact"
                          className="text-lg font-semibold hover:text-gray-200 transition duration-300">
                        Contact
                    </Link>
                </div>
            ...
            {menuOpen && (
                <div
                    ...
                    <Link href="/public" className="hover:text-gray-300 transition duration-300"
