...
export default function Navbar() {
    ...
    return (
        <nav
            className="bg-gray-100 text-black shadow-md fixed w-full z-10 px-10 py-4"
        >
            ...
            {menuOpen && (
                <div
                    ...
                    <Link href="/"
                          className={`transition duration-300 ${pathname === "/" ? "underline decoration-yellow-300 underline-offset-4" : "hover:text-gray-300"}`}
                          onClick={() => setMenuOpen(false)}>
                        Home
                    </Link>
                    <Link href="/about"
                          className={`transition duration-300 ${pathname === "/about" ? "underline decoration-yellow-300 underline-offset-4" : "hover:text-gray-300"}`}
                          onClick={() => setMenuOpen(false)}>
                        About
                    </Link>
                    <Link href="/projects"
                          className={`transition duration-300 ${pathname === "/projects" ? "underline decoration-yellow-300 underline-offset-4" : "hover:text-gray-300"}`}
                          onClick={() => setMenuOpen(false)}>
                        Projects
                    </Link>
                    <Link href="/contact"
                          className={`transition duration-300 ${pathname === "/contact" ? "underline decoration-yellow-300 underline-offset-4" : "hover:text-gray-300"}`}
                          onClick={() => setMenuOpen(false)}>
                        Contact
                    </Link>
                </div>
